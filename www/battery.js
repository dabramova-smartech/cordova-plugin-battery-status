...
var Battery = function () {
    ...
    this.channels = {
        ...
        batterytest: cordova.addWindowEventHandler("batterytest"),
...
/**
 * Get monitored battery status - dictionary (isPlugged, level)
 */
Battery.prototype.getMonitoredStatus = function (callback) {
    exec(function (result) {
        if (callback) {
            callback(result);
        }
    }, function (error) {
        console.log("Error getting battery monitored status", error)
    }, "Battery", "getBatteryObservedStatus", []);
};

/**
 * Get battery level - int
 */
Battery.prototype.getBatteryLevel = function (callback) {
    exec(function (result) {
        if (callback) {
            callback(result);
        }
